...
# Create private app tier subnets
...
# Create private database tier subnets
...
# Create private route tables for app tier (one per AZ)
...
# Create private route table for database tier
...
# Associate private database subnets with database route table
